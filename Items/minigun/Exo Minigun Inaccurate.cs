...
{
    public class ExoMinigunInaccurate : ModItem // Change the itemname into name of your shotgun.
    {
        ...
        public override bool PreShoot(Player player, Vector2 ShootPos, Vector2 ShootVelocity, int projType, int Damage, float knockback)
        {
            ...
            int spread = 27; // Shot spread
            float spreadMult = 0.07f; // Spread multiplier
